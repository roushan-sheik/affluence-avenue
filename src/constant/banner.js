export const bannerData = [
...

  {
    ...
    description:
      "Escape to paradise at this exclusive luxury resort in Bali. Immerse yourself in world-class amenities, personalized service, and breathtaking tropical views, creating the ultimate sanctuary for relaxation and rejuvenation.",
  },
  {
    id: 4,
    title: "Private Island Retreat in the Caribbean",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0CRVi0bdaJtN5SIbxmnC_etkYSknvrgl9C8UoyaMHy4d89tssV44sYf8LROXQH6pg9So&usqp=CAU",
    description:
      "Experience ultimate privacy and luxury on your own Caribbean private island. Pristine beaches, luxurious accommodations, and exclusive amenities create an extraordinary tropical escape for the discerning traveler.",
  },
  {
    id: 5,
    title: "Mansion in Beverly Hills",
    image:
      "https://robbreport.com/wp-content/uploads/2023/01/Beverly_Ridge8.jpg?w=1000",
    description:
      "Live in luxury in this sprawling Beverly Hills mansion. Palatial interiors, manicured gardens, and world-class amenities offer the epitome of Hollywood glamour and sophisticated California living.",
  },
  {
    id: 6,
    title: "Waterfront Estate in Miami",
    image:
      "https://robbreport.com/wp-content/uploads/2022/02/Indian-Spring-Rear-Exterior-with-Pool.jpg",
    description:
      "Experience waterfront living at its finest in this Miami estate. Panoramic bay views, luxurious outdoor spaces, and private dock access offer the perfect blend of elegance and relaxation in the heart of Biscayne Bay.",
  },
  {
    id: 7,
    title: "Ski Chalet in Aspen",
    image: "https://robbreport.com/wp-content/uploads/2022/12/1-4.jpg?w=1000",
    description:
